...
var Setup = Object(mobx_react__WEBPACK_IMPORTED_MODULE_2__["observer"])(_class = (_class2 =
/*#__PURE__*/
function (_Component) {
  ...
  function Setup() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Setup)).call.apply(_getPrototypeOf2, [this].concat(args)));

    _initializerDefineProperty(_this, "loading", _descriptor, _assertThisInitialized(_assertThisInitialized(_this)));

    _initializerDefineProperty(_this, "subdomain", _descriptor2, _assertThisInitialized(_assertThisInitialized(_this)));

    _initializerDefineProperty(_this, "apiKey", _descriptor3, _assertThisInitialized(_assertThisInitialized(_this)));

    _this.onChange = function (e) {
      _this[e.target.name] = e.target.value;
    };

    _this.onSubmit = function (_e) {
      chrome.storage.sync.set({
        subdomain: _this.subdomain.trim(),
        api_key: _this.apiKey.trim()
      }, function () {
        return window.close();
      });
    };
  ...
  _createClass(Setup, [{
    ...
    value: function componentDidMount() {
      ...
      chrome.storage.sync.get(null, function (store) {
        ...
        _this2.subdomain = store.subdomain || "";
        _this2.apiKey = store.api_key || "";
      });
    } // EVENTS
  ...
  return Setup;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "loading", [mobx__WEBPACK_IMPORTED_MODULE_1__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
...
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "subdomain", [mobx__WEBPACK_IMPORTED_MODULE_1__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "apiKey", [mobx__WEBPACK_IMPORTED_MODULE_1__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
/* harmony import */ var _components_Setup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/Setup */ "./src/js/components/Setup.js");



var domContainer = document.querySelector('#moco-bx-container');
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_components_Setup__WEBPACK_IMPORTED_MODULE_2__["default"]), domContainer);
